...
// Doc_View_StructDoc.cpp: CDocViewStructDoc 클래스의 구현
//
...
// CDocViewStructDoc serialization
...
// 축소판 그림을 지원합니다.
void CDocViewStructDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CDocViewStructDoc::InitializeSearchContent()
{
...
void CDocViewStructDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
